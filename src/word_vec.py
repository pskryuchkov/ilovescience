...
# python word_vec.py -b cond-mat.16.03
#
# topics word vectors info
# python word_vec.py -t cond-mat.16.03
#
# word2vec console
# python word_vec.py -c cond-mat.16.03
...
def topics_info(word_vec_path):
    ...
    topics = topics_normalize(model, get_topics(topics_path))
...
# initialization
stoplist = get_topics("stoplist.txt")
arg_run()
